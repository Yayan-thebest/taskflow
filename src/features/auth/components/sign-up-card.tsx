...
export const SignUpCard = () => {
    ...
    return (
        <Card className="w-full h-full md:w-[487px] border-none shadow-none">
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <Button disabled={isPending} size="lg" className="w-full">
                            {isPending ? <Loader className="mr-1 size-5 animate-spin" /> : "Register"}
                        </Button>
                    </form>
                </Form>
            </CardContent>
            ...
            <CardDescription className="p-7  gap-y-4 text-center">
                By signing up, you agree to our {" "} 
                <Link href="/privacy" className="text-blue-700">Privacy Policy</Link>
                {" "} and {" "}
                <Link href="/terms" className="text-blue-700">Terms os Service</Link>
            </CardDescription>
        </Card>
    )
}