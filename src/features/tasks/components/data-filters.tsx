...
import { CheckCircleIcon, ClockIcon, EyeIcon, FolderIcon, ListCheckIcon, ListTodoIcon, LoaderIcon, UserIcon } from "lucide-react";
...
export const DataFilters = ({ hideProjectFilter }: DataFiltersProps ) => {
    ...
    const onStatusChange = (value: string) => {
        setFilters({ status: value === "all" ? null : value as TasksStatus})
    };
